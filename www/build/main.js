...
var ChangeProgramPage = /** @class */ (function () {
    ...
    ChangeProgramPage = ChangeProgramPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-change-program',template:/*ion-inline-start:"C:\Users\anish\Desktop\USP_ES-v7\src\pages\change-program\change-program.html"*/'<!--\n  Generated template for the ChangeProgramPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <img src="assets/imgs/USP_logo.jpg" width="40px" style="display:inline-block" height="80px" width="150px"/>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="showFilters()">\n        <ion-icon name="funnel"></ion-icon> \n      </button>\n    </ion-buttons>\n  </ion-navbar>  \n\n</ion-header>\n\n<ion-menu [content]="content9" side="right" id="filters-9">\n  Menu\n  <ion-item>\n    <button  ion-button (click)="HomePage()">\n      Home\n    </button>\n  </ion-item>\n  <ion-item>\n      <button  ion-button (click)="CoursesPage()">\n        Program Audit\n      </button>\n    </ion-item>\n    <ion-item>\n        <button  ion-button (click)="EnrollNowPage()"> \n          Enroll Now\n        </button>\n      </ion-item>\n      <ion-item>\n        <button  ion-button (click)="PersonalDetailsPage()">\n          My Details\n        </button>\n      </ion-item>\n          <ion-item>\n              <button  ion-button (click)="MyProgramPage()">\n                My Program\n              </button>\n            </ion-item>\n            <ion-item>\n              <button  ion-button (click)="hideFilters()">\n                Apply for Change Program\n              </button> \n            </ion-item>\n            <ion-item>\n              <button  ion-button (click)="RecheckPage()">\n                Apply for Recheck of Grades\n              </button>\n            </ion-item>\n            <ion-item>\n              <button  ion-button (click)="GraduationApplicationPage()">\n                Apply for Graduation\n              </button>\n            </ion-item>\n          <ion-item>\n          <button  ion-button (click)="LoginPage()">\n            Logout\n          </button>\n        </ion-item>\n</ion-menu>\n\n<ion-content padding #content9>\n\n\n</ion-content>\n'/*ion-inline-end:"C:\Users\anish\Desktop\USP_ES-v7\src\pages\change-program\change-program.html"*/,
        }),
...
var RecheckPage = /** @class */ (function () {
    ...
    RecheckPage = RecheckPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-recheck',template:/*ion-inline-start:"C:\Users\anish\Desktop\USP_ES-v7\src\pages\recheck\recheck.html"*/'<ion-header>\n\n  <ion-navbar>\n    <img src="assets/imgs/USP_logo.jpg" width="40px" style="display:inline-block" height="80px" width="150px"/>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="showFilters()">\n        <ion-icon name="funnel"></ion-icon> \n      </button>\n    </ion-buttons>\n  </ion-navbar>  \n\n</ion-header>\n\n<ion-menu [content]="content10" side="right" id="filters-10">\n  Menu\n  <ion-item>\n    <button  ion-button (click)="HomePage()">\n      Home\n    </button>\n  </ion-item>\n  <ion-item>\n      <button  ion-button (click)="CoursesPage()">\n        Program Audit\n      </button>\n    </ion-item>\n    <ion-item>\n        <button  ion-button (click)="EnrollNowPage()"> \n          Enroll Now\n        </button>\n      </ion-item>\n      <ion-item>\n        <button  ion-button (click)="PersonalDetailsPage()">\n          My Details\n        </button>\n      </ion-item>\n          <ion-item>\n              <button  ion-button (click)="MyProgramPage()">\n                My Program\n              </button>\n            </ion-item>\n            <ion-item>\n              <button  ion-button (click)="ChangeProgramPage()">\n                Apply for Change Program\n              </button> \n            </ion-item>\n            <ion-item>\n              <button  ion-button (click)="hideFilters()">\n                Apply for Recheck of Grades\n              </button>\n            </ion-item>\n            <ion-item>\n              <button  ion-button (click)="GraduationApplicationPage()">\n                Apply for Graduation\n              </button>\n            </ion-item>\n          <ion-item>\n          <button  ion-button (click)="LoginPage()">\n            Logout\n          </button>\n        </ion-item>\n</ion-menu>\n\n<ion-content padding #content10>\n\n\n</ion-content>\n'/*ion-inline-end:"C:\Users\anish\Desktop\USP_ES-v7\src\pages\recheck\recheck.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* MenuController */]])
    ], RecheckPage);
    return RecheckPage;
